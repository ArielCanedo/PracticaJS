...
const ImgAlle=(a,b,c)=>{
    ...
    fetch(a).then((res) => {
        ...
        if(res.status !=200){
            ...
            let fakeUrlImg="./assets/xmark.svg";
            let fakeName="";
    ...
    if (gateB > 0){ 
        ...
        FakeimgFsturl={0:"./assets/xmark.svg"};
        FakeimgFsturlName={0:""};
    ...
    if (gateC > 0){ 
        ...
        FakeimgSndurl={0:"./assets/xmark.svg"};
        FakeimgSndurlName={0:""};
...
const AndereImg=(h,s)=>{
    ...
    if(h==null){
        ...
        imageP.setAttribute("src",`./assets/xmark.svg`);
    ...
    if(s==null){
        ...
        imageS.setAttribute("src",`./assets/xmark.svg`);
...
/*-------------------------------------Impresion de info---------------------------------------------------*/
    ...
    const Heightfunction=($Height)=>{
        ...
        imageWei.setAttribute("src","./assets/ruler.svg");
    ...
    const Weightfunction=($Weight)=>{
        ...
        const imageWei=document.createElement("img");
        imageWei.setAttribute("src","./assets/weight.svg");
        imageWei.setAttribute("width","25px");
    ...
    const Habitatfunction=($HabitatF)=>{
        ...
        const imageWei=document.createElement("img");
        imageWei.setAttribute("src","./assets/tree.svg");
